...
describe("[Challenge] The rewarder", function () {
  ...
  before(async function () {
    /** SETUP SCENARIO - NO NE§ED TO CHANGE ANYTHING HERE */
  ...
  it("Execution", async function () {
    ...
    const TheRewarderAttack = await TheRewarderAttackFactory.deploy(
      rewarderPool.address,
      liquidityToken.address,
      rewardToken.address
    );
    await TheRewarderAttack.connect(player).attack(flashLoanPool.address);
  });
